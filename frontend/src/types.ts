...
export interface PublicHomeResponse {
  ...
  account_pool: PublicAccountPoolStats;
  latest_key: string;
  maintenance: {
    enabled: boolean;
    message: string;
...
export interface PublicAccountPoolPlanStat {
  type: string;
  label: string;
  total: number;
  available: number;
...
export interface PublicAccountPoolStats {
  total: number;
  available: number;
  rate_limited: number;
  ...
  disabled: number;
  refreshing: number;
  plans: PublicAccountPoolPlanStat[];
}
...
export interface SystemSettings {
  ...
  ip_qps_limit: number;
  ip_rpm_limit: number;
  ip_auto_ban_enabled: boolean;
  ip_auto_ban_duration_minutes: number;
  ip_auto_ban_on_qps: boolean;
  ip_auto_ban_on_rpm: boolean;
  test_model: string;
...
export interface IPBan {
  id: number;
  ip: string;
  reason: "manual" | "qps_limit" | "rpm_limit" | string;
