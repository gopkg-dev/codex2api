...
const navDefs: NavDef[] = [
  ...
  {
    to: "/prompt-filter/overview",
    labelKey: "nav.promptFilter",
    icon: <ShieldAlert className="size-[18px]" />,
    activePrefix: "/prompt-filter",
  },
  {
    to: "/ops/overview",
    labelKey: "nav.ops",
  ...
  return (
    <div className="min-h-dvh">
      <div className="grid grid-cols-[264px_minmax(0,1fr)] max-w-full max-lg:grid-cols-1 max-lg:px-3">
          ...
          <div className="flex flex-col h-full px-4 pt-5 pb-4">
            ...
            <div className="pb-4 border-b border-border">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col gap-1">
                  <h1
                    className="max-w-[160px] truncate text-[20px] leading-tight font-bold text-foreground"
                    title={siteName}
                  >
                    {siteName}
                  </h1>
            ...
            <div className="mt-auto flex items-center justify-between gap-2 border-t border-border pt-3">
              ...
              <div className="flex items-center gap-0.5">
                ...
                >
                  <span
                    className={`inline-flex transition-transform duration-500 ease-out ${spinning ? "rotate-[360deg] scale-110" : "rotate-0 scale-100"}`}
                  >
                    {theme === "dark" ? (
        ...
        <main className="min-w-0 p-5 max-lg:p-3 max-lg:pb-[92px]">
          ...
          <header className="hidden max-lg:flex items-center justify-between gap-4 mb-4 p-3 border border-border rounded-lg bg-card/95 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              />
              <strong
                className="max-w-[150px] truncate text-lg"
                title={siteName}
              >
                {siteName}
              </strong>
        ...
        {/* Mobile bottom nav */}
        <nav
          className="fixed left-3 right-3 bottom-3 z-40 hidden max-lg:flex gap-1 overflow-x-auto rounded-xl border border-border bg-card/95 p-1.5 shadow-lg backdrop-blur-[20px] [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
